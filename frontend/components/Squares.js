...
export default function Squares() {
  ...
  const [squares] = useState(listOfSquareIds) // tracks number of squares
  // setSquares is not used bc the number of squares for this exercise is never going to change
