...
export default function Programmers() {
  ...
  // list of programmer isn't going to change so don't need setProgrammers
  const [selectedProgrammer, setSelectedProgrammer] = useState(null) 
  // null bc when the page is loaded no programmer is being featured until button is clicked
